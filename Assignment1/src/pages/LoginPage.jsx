                    ...
                    <Col>
                        <Form noValidate validated={validated} onSubmit={handleSubmit} className='p-4'>
                            ...
                            <Form.Group className="mb-2">
                                <Form.Control required onChange={(e) => setPassword(e.target.value)} value={password} className='fs-4' type="password" placeholder="Mật khẩu" />
                                <Form.Control.Feedback type="invalid">Hãy cung cấp mật khẩu</Form.Control.Feedback>
                            </Form.Group>
